...
public class UserServiceImpl implements UserService {
	...
	@Override
	public boolean updateHits(int userId) {
	
		if (userMapper.updateHits(userId) > 0) {
            return true;
        }
		return false;
	}
	...
	@Override
	public PageInfo<UserdesireBO> searchUser(String keyword, String orderBy, int page, int limit) {
		// TODO Auto-generated method stub
		PageHelper.startPage(page, limit);

        List<UserdesireBO> searchList = userMapper.listSearchUsr("%" + keyword + "%",orderBy);
